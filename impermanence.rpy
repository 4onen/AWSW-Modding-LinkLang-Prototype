...
search if
change "persistent.brycegoodending == True" to "False"
...
branch "mcfirst == True":
    ...
    change "persistent.sebastianfail == False" to "False"

# Depression is a deep cycle, Remy.
find label c4library
search if
change "persistent.remygoodending == True" to "False"
find label chapter5
...
change "persistent.trueending" to "False"
search scene o4
callto impermanence_end_fix
